...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| `vector` | 50.00% | 80.56% | 80.56% | 83.33% | 78.00% | 26.076 ms | 0 | 仅对照 |
| `bm25` | 33.33% | 38.89% | 69.44% | 58.89% | 51.76% | 2.486 ms | 0 | 仅对照 |
| `hybrid` | 41.67% | 61.11% | 61.11% | 58.33% | 60.21% | 27.581 ms | 0 | 未通过 |
| `reranked` | 63.89% | 86.11% | 86.11% | 91.67% | 89.68% | 13444.536 ms | 0 | 通过 |
